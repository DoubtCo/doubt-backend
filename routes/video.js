...
const { textSearch, getVideoById, deleteVideo} = require('../controllers/video');
...
router.post('/upload/:questionID',auth,upload.fields([{name:'video',maxCount:1}, {name:'image', maxCount:4},{name:'note',maxCount:3}]),uploadSolution); //Middleware uploads to S3 while controllers update DB
